...
*Create a CSV file for others to work with the data, rename some variables.
rename students student_cases
rename staff staff_cases
rename staff_fte staff_employment
export delimited reportdate unmaskweek student_cases staff_cases staff_employment enrollment stud_case_percap staff_case_percap ///
stud_case_percap_L1 staff_case_percap_L1 stud_case_percap_L2 staff_case_percap_L2 stud_case_percap_L3 ///
staff_case_percap_L3 stud_av staff_av using ./data/nejm_case_data.csv, replace
